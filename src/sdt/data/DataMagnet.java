 ...
 * @version 1.0
 */
public class DataMagnet extends DataSolid
{
    protected ElementPoint _elementPtXZLeftDown;
    protected ElementPoint _elementPtXZRightUp;
    protected ElementPoint _elementPtYZLeftDown;
    ...
    public DataMagnet(SDT_DataManager dataManger)
    {
        ...
        _dataType = this.TYPE_MAGNET;
        _point3DStartSection1 = new stepb_cartesian_point(0, 0, -1.5);
        _point3DEndSection1 = new stepb_cartesian_point(1, 0, -2);
        _point3DStartSection2 = new stepb_cartesian_point(0, 0, -1.5);
        _point3DEndSection2 = new stepb_cartesian_point(0, 1, -2);
        this._colorBody    =  this._dataManager.getColorMagnet();
    ...
    protected void setDataToElementYZ()
    {
        if (this._elementPtYZStart == null)
            this._elementPtYZStart = new ElementPoint(_point3DStartSection2.X(), _point3DStartSection2.Z(), _colorPt,this);

        if (this._elementPtYZEnd == null)
            this._elementPtYZEnd = new ElementPoint(_point3DEndSection2.X(), _point3DEndSection2.Z(), _colorPt,this);
    ...
    public ElementPoint getElementPointLeftDown( int sectionNumber)
    {
         switch (sectionNumber)
         {
             case DefineSystemConstant.XZView:
                 return this._elementPtXZLeftDown;

             case DefineSystemConstant.YZView:
                 return this._elementPtYZLeftDown;
    ...
    public ElementPoint getElementPointRightUp(int sectionNumber)
    {
        switch (sectionNumber)
        {
            case DefineSystemConstant.XZView:
                return this._elementPtXZRightUp;

            case DefineSystemConstant.YZView:
                return this._elementPtYZRightUp;
    ...
    public void setElementPointLeftDown(ElementPoint leftDownPt, int sectionNumber)
   {
       switch (sectionNumber)
       {
           case DefineSystemConstant.XZView:
               this._elementPtXZLeftDown = leftDownPt;
               this._point3DStartSection1.GetMathVector3d().SetX(_elementPtXZLeftDown.X());
               this._point3DEndSection1.GetMathVector3d().SetZ(_elementPtXZLeftDown.Y());
               break;
           case DefineSystemConstant.YZView:
               this._elementPtYZLeftDown = leftDownPt;
               this._point3DStartSection2.GetMathVector3d().SetY(_elementPtYZLeftDown.X());
               this._point3DEndSection2.GetMathVector3d().SetZ(_elementPtYZLeftDown.Y());
               break;
           case DefineSystemConstant.XYView:
               break;
       }
