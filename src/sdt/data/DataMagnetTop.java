 ...
 * @version 1.0
 */
public class DataMagnetTop extends DataMagnet
{

    public DataMagnetTop(SDT_DataManager dataManger)
    {
        super(dataManger);

        _dataType = this.TYPE_MAGNETTOP;
        _point3DStartSection1 = new stepb_cartesian_point(0, 0, -0.75);
        _point3DEndSection1 = new stepb_cartesian_point(1, 0, -1);
        _point3DStartSection2 = new stepb_cartesian_point(0, 0, -0.75);
        _point3DEndSection2 = new stepb_cartesian_point(0, 1, -1);

        this._colorBody      = this._dataManager.getColorMagnetTop();
        this._geometryType = DefineSystemConstant.MAGNETTOP_TYPE1;
...
*/
        ...
        this._elmementXZ.setElementType(DefineSystemConstant.TYPE_MAGNETTOP);
...
*/
        ...
        this._elmementYZ.setElementType(DefineSystemConstant.TYPE_MAGNETTOP);
        _isXYupdateNeed = true;
    }
