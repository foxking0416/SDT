 ...
 * @version 1.0
 */
public class DiaExportMacFile extends DiaMain
{
    ...
    public DiaExportMacFile(SDT_System system)
    {
        super(system, true);
        try
        {
    ...
    public void progress2()
    {
        ...
        this._system.getDataManager().createAnsysBatAndRun();
   ...
   private class ThreadLogRead implements Runnable
    {
        ...
        public void run()
        {
          ...
          //      bool2 = _system.getDataManager().CheckIsAbaqusLogCompeleted();
               bool2 = true;
                if ( bool2 == true)
                {
